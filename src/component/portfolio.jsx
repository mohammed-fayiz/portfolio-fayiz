...
const skillArray=['C','JavaScript','CSS3','HTML5','React.JS','BootStrap','Material UI','Motion Framer','Node.JS','Express.JS','MongoDB','Git','GitHub','Vercel','Render','multer','Toastify','nodemon','CORS','Axios']
